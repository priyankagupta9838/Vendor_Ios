...
class RestorationAcceptedReviewQuotes extends StatefulWidget {
  RestorationAcceptedReviewQuotes({super.key,required this.service,required this.clothingItem,required this.clothingType,
    required this.styleDescription,required this.selectedAddOn,required this.estimatedPrice,required this.day,
    required this.refImage_1,required this.refImage_2,required this.quote_id});
  String service;
  String clothingItem;
  String clothingType;
  ...
  @override
  State<RestorationAcceptedReviewQuotes> createState() => _RestorationAcceptedReviewQuotesState();
}

class _RestorationAcceptedReviewQuotesState extends State<RestorationAcceptedReviewQuotes> {
