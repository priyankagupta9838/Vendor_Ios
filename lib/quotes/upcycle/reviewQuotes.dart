...
class ReviewQuotes extends StatefulWidget {
 ReviewQuotes({super.key,required this.service,required this.clothingItem,
   required this.styleDescription,required this.selectedAddOn,required this.estimatedPrice,required this.day,
   required this.refImage_1,required this.refImage_2,required this.matImage_1,required this.matImage_2,required this.quote_id,required this.userDetail,required this.mesurmentDetail});
  String service;
  String clothingItem;
 ...
 Map<String ,dynamic> mesurmentDetail;
  ...
  @override
  State<ReviewQuotes> createState() => _ReviewQuotesState();
}

class _ReviewQuotesState extends State<ReviewQuotes> {
  ...
  void initState() {
     ...
     clothingItemController.text=widget.clothingItem.toString();
    // clothingTypeController.text=widget.clothingType.isNotEmpty?widget.clothingType:"";
     ...
     // neckController.text=widget.neck.isNotEmpty?widget.neck:"";
     // shoulderController.text=widget.shoulder.isNotEmpty?widget.shoulder:"";
     // armLengthController.text=widget.armelength.isNotEmpty?widget.armelength:"";
     // waistController.text=widget.waist.isNotEmpty?widget.waist:"";
     ...
     numberOfDay=int.parse(widget.day)>=0?int.parse(widget.day):0;
           print("user detail is ${widget.userDetail}....................................");
                            ...
                            fontSize: size.height * 0.02,
                              ...
                              suffixIcon: TextButton(onPressed: (){
                                Navigator.push(context, PageTransition(
                                    childCurrent: ReviewQuotes(
                                        service: '', clothingItem: '',
                                        styleDescription: '',
                                        selectedAddOn:'', estimatedPrice: '', day: null, refImage_1: '', refImage_2: '', matImage_1: '', matImage_2: '', quote_id: null, userDetail: {}, mesurmentDetail: {},),
                                      ...
                                      onTap: () async {
                                        if(rejectedController.text.toString().trim().isNotEmpty){
                                          ...
                                          await QuotesApi().acceptRejectQuotes(widget.quote_id,false,rejectedController.text,numberOfDay.toString()).then((value) async {
                                            if(value=="success"){
                                              await NotificationServices().sendNotification(widget.userDetail["id"].toString(),"Quotes","Your Quote is rejected by ${userModel["vendor_details"]["shop_name"].toString()}");
                              ...
                              return  GestureDetector(
                                onTap: () async {
                                  ...
                                  await QuotesApi().acceptRejectQuotes(widget.quote_id,true," ",numberOfDay.toString()).then((value) async {
                                    if(value=="success"){
                                  await NotificationServices().sendNotification(widget.userDetail["id"].toString(),"Quotes","Your Quote is accepted by ${userModel["vendor_details"]["shop_name"].toString()}");
                                   buttonClicked=false;
                                     edit=true;
                                     setState(() {
