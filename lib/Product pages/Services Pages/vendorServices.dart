...
import '../addon/addonStream.dart';
import '../addon/createaddon.dart';
import 'addingService.dart';
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              return snapshot.data?.statusCode == 200
                  ?  UpCycleServices(serviceType: userModel["vendor_details"]["service_type"].toString().toUpperCase()=="RESTORATION" ? restoreServiceType : upCycleServiceType,)
                  : Column(
                children: [
                  AutoSizeText(
                    "",
                  ...
                  onPressed: () {
                    Navigator.push(
                        ...
                        PageTransition(
                            ...
                            childCurrent: const VendorServices(),
                            child:  AddingNewService( serviceType: userModel["vendor_details"]["service_type"].toString().toUpperCase()=="RESTORATION"
