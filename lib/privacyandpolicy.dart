...
import 'Account Related/onlinePdfViewer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: AutoSizeText("Privacy and Policy",style: GoogleFonts.cabin(
      ...
      body: Container(
        ...
        child:  SingleChildScrollView(
          ...
          child:   OnlinePdfViewer(
              url:"$baseIp/api/static-properties/privacy-policy")


          /*StreamBuilder(
            stream:Authentication().privacyAndPolicy(),
            builder: (context, snapshot) {
              if( snapshot.hasData ){
                ...
                //   width: size.width*1,
                //   child:
                //   data["data"][0]["property_value"].toString() !="" &&  data["data"][0]["property_value"]!=null
                //       ?
                //
                //   Image.network(data["data"][0]["property_value"],fit: BoxFit.fill)
                //       :
