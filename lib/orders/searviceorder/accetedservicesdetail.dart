...
class AcceptedServicesDetails extends StatefulWidget {
  AcceptedServicesDetails({Key? key , required this.orderDetails,required this.orderId}) : super(key: key);
  Map<String,dynamic>orderDetails;
  String orderId;

  @override
  State<AcceptedServicesDetails> createState() => _AcceptedServicesDetailsState();
}

class _AcceptedServicesDetailsState extends State<AcceptedServicesDetails> {
...
@override
  void initState() {
    ...
    super.initState();
    print("Services order detail is ..${widget.orderDetails}");
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: AutoSizeText("Accepted Service Order Details",style: GoogleFonts.cabin(
            color: Colors.white,
                                  ...
                                  await  FirebaseFirestore.instance
                                    ...
                                    if(value.data()!=null){
                                      for(var channels in value.data()?["Channels"]){
                                        if(channels["userId"].toString()=="${widget.orderDetails["user_id"]}"){
                                          Navigator.push(context, PageTransition(
                                              type: PageTransitionType.fade,
                                              duration: const Duration(milliseconds: 50),
                                              childCurrent:AcceptedServicesDetails(orderDetails: {}, orderId: '',),
