...
class DeliveredServicesDetails extends StatefulWidget {
  const DeliveredServicesDetails({Key? key}) : super(key: key);

  @override
  State<DeliveredServicesDetails> createState() => _DeliveredServicesDetailsState();
}

class _DeliveredServicesDetailsState extends State<DeliveredServicesDetails> {
  @override
